...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{add beautiful and reusable chart with one line of ruby  Charts from ChartJS.}
  spec.description   = %q{Add beautiful and reusable chart with one line of ruby}
